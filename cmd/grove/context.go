...
--json is the stable contract other tools should read. is_main marks the
context that is the project itself, which is the main clone where there is one
and a worktree of a bare repository where there is not.`,
