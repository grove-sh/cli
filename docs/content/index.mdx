---
title: Introduction
description: Grove gives every git worktree its own HTTPS hostname, its own leased ports, and its own environment, so several checkouts of a repository run at once without colliding.
sidebar:
  icon: home
---
